# Navigation Scenario Adapted for truly shared rewards
import typing
...
class Scenario(BaseScenario):
    ...
    def reward(self, agent: Agent):
        ...
        if is_first:
            ...
            self.shared_agent_collision_rew = torch.zeros_like(self.pos_rew)
            ...
            for i, a in enumerate(self.world.agents):
                for j, b in enumerate(self.world.agents):
                    ...
                    if self.world.collides(a, b):
                        ...
                        self.shared_agent_collision_rew[collision_mask] += 2 * self.agent_collision_penalty

        pos_reward = self.pos_rew if self.shared_rew else agent.pos_rew
        col_reward = self.shared_agent_collision_rew if self.shared_rew else agent.agent_collision_rew
        return pos_reward + self.final_rew + col_reward
